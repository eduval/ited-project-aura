...
# Automatically find the first .xlsx file in the folder (excluding temporary and output files)
input_file = None
for file in os.listdir():
    if file.endswith(".xlsx") and not file.startswith("~$") and "output" not in file.lower():
        input_file = file
        break

if not input_file:
    raise FileNotFoundError("No valid .xlsx file found in this directory.")
...
for student in students:
    ...
    # These are added to store attendance and grades for average calculation.... 
    attendance_values = []
    grade_values = []
    ...
    # --- These change is really importantt. I am computing the averages manually (not with formulas) ---
...
# This line is only for testing and double check the process..
...
print("✅ All intake transcripts have been generated and saved in:", output_dir)
